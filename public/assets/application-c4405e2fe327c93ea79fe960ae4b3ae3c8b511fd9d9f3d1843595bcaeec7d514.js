...
(function() {
  jQuery(function() {
    ...
    return $('#application_district_id').change(function() {
      ...
      if (options) {
        ...
        return $('#application_sector_id').val(0);
      } else {
        $('#application_sector_id').empty();
        return $('#application_sector_id').parent().hide();
      }
    });
  });
...
(function() {
  jQuery(function() {
    ...
    return $('#employer_district_id').change(function() {
      var district, escaped_district, options;
      ...
      if (options) {
        ...
        return $('#employer_sector_id').val(0);
      } else {
        $('#employer_sector_id').empty();
        return $('#employer_sector_id').parent().hide();
      }
    });
  });
